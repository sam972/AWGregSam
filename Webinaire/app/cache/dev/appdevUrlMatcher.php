...
class appdevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (rtrim($pathinfo, '/') === '') {
            if (substr($pathinfo, -1) !== '/') {
                return $this->redirect($pathinfo.'/', 'webinaire_accueil');
            }

            return array (  '_controller' => 'Wbn\\WebinaireBundle\\Controller\\WebinaireController::indexAction',  '_route' => 'webinaire_accueil',);
        }

        // webinaire_faq
        if ($pathinfo === '/faq') {
            return array (  '_controller' => 'Wbn\\WebinaireBundle\\Controller\\WebinaireController::faqAction',  '_route' => 'webinaire_faq',);
        }

        // webinaire_support
        if ($pathinfo === '/support') {
            return array (  '_controller' => 'Wbn\\WebinaireBundle\\Controller\\WebinaireController::supportAction',  '_route' => 'webinaire_support',);
        }

        // webinaire_apropos
        if ($pathinfo === '/apropos') {
            return array (  '_controller' => 'Wbn\\WebinaireBundle\\Controller\\WebinaireController::aproposAction',  '_route' => 'webinaire_apropos',);
        }

        // webinaire_membre
        if ($pathinfo === '/membre') {
            return array (  '_controller' => 'Wbn\\WebinaireBundle\\Controller\\WebinaireController::membreAction',  '_route' => 'webinaire_membre',);
        }
