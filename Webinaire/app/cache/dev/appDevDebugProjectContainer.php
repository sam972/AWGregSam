...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), '/Users/samuelrenel/Web/AWGregSam/Webinaire/app/cache/dev/annotations', true);
    }
    ...
    {
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig')), new \Assetic\Cache\ConfigCache('/Users/samuelrenel/Web/AWGregSam/Webinaire/app/cache/dev/assetic/config'), true)));

        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($this->get('templating.loader'), '', '/Users/samuelrenel/Web/AWGregSam/Webinaire/app/Resources/views', '/\\.[^.]+\\.twig$/'), 'twig');
    ...
    protected function getCacheWarmerService()
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplateFinder($a, $b, '/Users/samuelrenel/Web/AWGregSam/Webinaire/app/Resources');
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('dbname' => 'webinaire', 'host' => 'localhost', 'port' => '', 'user' => 'root', 'password' => 'root', 'charset' => 'UTF8', 'driver' => 'pdo_mysql', 'driverOptions' => array()), $b, $c, array());
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return EM50740f0c0c256_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager A EM50740f0c0c256_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager instance.
     */
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        require_once '/Users/samuelrenel/Web/AWGregSam/Webinaire/app/cache/dev/jms_diextra/doctrine/EntityManager.php';

        $a = $this->get('annotation_reader');

        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_6bb8c85a9f7b9861ee4a017289721f47');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_6bb8c85a9f7b9861ee4a017289721f47');

        $d = new \Doctrine\Common\Cache\ArrayCache();
        $d->setNamespace('sf2orm_default_6bb8c85a9f7b9861ee4a017289721f47');

        $e = new \Doctrine\ORM\Mapping\Driver\SimplifiedXmlDriver(array('/Users/samuelrenel/Web/AWGregSam/Webinaire/vendor/fos/userbundle/FOS/UserBundle/Resources/config/doctrine' => 'FOS\\UserBundle\\Entity'));
        $e->setGlobalBasename('mapping');

        $f = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => '/Users/samuelrenel/Web/AWGregSam/Webinaire/src/Wbn/WebinaireBundle/Entity', 1 => '/Users/samuelrenel/Web/AWGregSam/Webinaire/src/Wbn/UserBundle/Entity'));

        $g = new \Doctrine\ORM\Mapping\Driver\DriverChain();
        $g->addDriver($e, 'FOS\\UserBundle\\Entity');
        $g->addDriver($f, 'Wbn\\WebinaireBundle\\Entity');
        $g->addDriver($f, 'Wbn\\UserBundle\\Entity');

        $h = new \Doctrine\ORM\Configuration();
        $h->setEntityNamespaces(array('FOSUserBundle' => 'FOS\\UserBundle\\Entity', 'WbnWebinaireBundle' => 'Wbn\\WebinaireBundle\\Entity', 'WbnUserBundle' => 'Wbn\\UserBundle\\Entity'));
        $h->setMetadataCacheImpl($b);
        $h->setQueryCacheImpl($c);
        $h->setResultCacheImpl($d);
        $h->setMetadataDriverImpl($g);
        $h->setProxyDir('/Users/samuelrenel/Web/AWGregSam/Webinaire/app/cache/dev/doctrine/orm/Proxies');
        ...
        return $this->services['doctrine.orm.default_entity_manager'] = new \EM50740f0c0c256_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager($i, $this);
    }
    ...
    {
        return $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator($this->get('kernel'), '/Users/samuelrenel/Web/AWGregSam/Webinaire/app/Resources');
    }
    ...
    {
        return $this->services['form.csrf_provider'] = new \Symfony\Component\Form\Extension\Csrf\CsrfProvider\SessionCsrfProvider($this->get('session'), '458edc0590db980af9f95347879fa1714d119a34');
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('Wbn\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('Wbn\\UserBundle\\Entity\\User');
    }
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('doctrine')->getManager(NULL), 'Wbn\\UserBundle\\Entity\\User');
    }
    ...
    protected function getJmsDiExtra_Metadata_MetadataFactoryService()
    {
        ...
        $instance->setCache(new \Metadata\Cache\FileCache('/Users/samuelrenel/Web/AWGregSam/Webinaire/app/cache/dev/jms_diextra/metadata'));
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler('/Users/samuelrenel/Web/AWGregSam/Webinaire/app/logs/dev.log', 100, true);
    }
    ...
    protected function getProfilerService()
    {
        ...
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\FileProfilerStorage('file:/Users/samuelrenel/Web/AWGregSam/Webinaire/app/cache/dev/profiler', '', '', 86400), $a);
    ...
    {
        return $this->services['router'] = new \Symfony\Bundle\FrameworkBundle\Routing\Router($this, '/Users/samuelrenel/Web/AWGregSam/Webinaire/app/cache/dev/assetic/routing.yml', array('cache_dir' => '/Users/samuelrenel/Web/AWGregSam/Webinaire/app/cache/dev', 'debug' => true, 'generator_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_base_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_dumper_class' => 'Symfony\\Component\\Routing\\Generator\\Dumper\\PhpGeneratorDumper', 'generator_cache_class' => 'appdevUrlGenerator', 'matcher_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_base_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_dumper_class' => 'Symfony\\Component\\Routing\\Matcher\\Dumper\\PhpMatcherDumper', 'matcher_cache_class' => 'appdevUrlMatcher', 'strict_requirements' => true), $this->get('router.request_context'), $this->get('monolog.logger.router'));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_LoginService()
    {
        ...
        return $this->services['security.firewall.map.context.login'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($a, array(0 => $this->get('fos_user.user_manager')), 'login', $b, $this->get('event_dispatcher')), 2 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($a, '50740f0bea81d', $b), 3 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, $this->get('security.authentication.trust_resolver'), $this->get('security.http_utils'), 'login', NULL, NULL, NULL, $b));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $h = new \Symfony\Component\Security\Http\RememberMe\TokenBasedRememberMeServices(array(0 => $b), '458edc0590db980af9f95347879fa1714d119a34', 'main', array('name' => 'REMEMBERME', 'lifetime' => 31536000, 'path' => '/', 'domain' => NULL, 'secure' => false, 'httponly' => true, 'always_remember_me' => false, 'remember_me_parameter' => '_remember_me'), $c);
        ...
        return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($a, array(0 => $b), 'main', $c, $d), 2 => $i, 3 => $k, 4 => new \Symfony\Component\Security\Http\Firewall\RememberMeListener($a, $h, $g, $c, $d), 5 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($a, '50740f0bea81d', $c), 6 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, $this->get('security.authentication.trust_resolver'), $e, 'main', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($f, $e, '/login', false), NULL, NULL, $c));
    }
    ...
    {
        return $this->services['sensio.distribution.webconfigurator'] = new \Sensio\Bundle\DistributionBundle\Configurator\Configurator('/Users/samuelrenel/Web/AWGregSam/Webinaire/app');
    }
    ...
    {
        return $this->services['session.handler'] = new \Symfony\Component\HttpFoundation\Session\Storage\Handler\NativeFileSessionHandler('/Users/samuelrenel/Web/AWGregSam/Webinaire/app/cache/dev/sessions');
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('/Users/samuelrenel/Web/AWGregSam/Webinaire/app/cache/dev/sessions');
    }
    ...
    {
        return $this->services['templating.helper.code'] = new \Symfony\Bundle\FrameworkBundle\Templating\Helper\CodeHelper(NULL, '/Users/samuelrenel/Web/AWGregSam/Webinaire/app', 'UTF-8');
    }
    ...
    {
        $this->services['translator.default'] = $instance = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, new \Symfony\Component\Translation\MessageSelector(), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini')), array('cache_dir' => '/Users/samuelrenel/Web/AWGregSam/Webinaire/app/cache/dev/translations', 'debug' => true));

        $instance->setFallbackLocale('fr');
        $instance->addResource('xlf', '/Users/samuelrenel/Web/AWGregSam/Webinaire/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.bg.xlf', 'bg', 'validators');
        $instance->addResource('xlf', '/Users/samuelrenel/Web/AWGregSam/Webinaire/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.ca.xlf', 'ca', 'validators');
        $instance->addResource('xlf', '/Users/samuelrenel/Web/AWGregSam/Webinaire/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.cs.xlf', 'cs', 'validators');
        $instance->addResource('xlf', '/Users/samuelrenel/Web/AWGregSam/Webinaire/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.da.xlf', 'da', 'validators');
        $instance->addResource('xlf', '/Users/samuelrenel/Web/AWGregSam/Webinaire/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.de.xlf', 'de', 'validators');
        $instance->addResource('xlf', '/Users/samuelrenel/Web/AWGregSam/Webinaire/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.en.xlf', 'en', 'validators');
        $instance->addResource('xlf', '/Users/samuelrenel/Web/AWGregSam/Webinaire/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.es.xlf', 'es', 'validators');
        $instance->addResource('xlf', '/Users/samuelrenel/Web/AWGregSam/Webinaire/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.et.xlf', 'et', 'validators');
        $instance->addResource('xlf', '/Users/samuelrenel/Web/AWGregSam/Webinaire/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.eu.xlf', 'eu', 'validators');
        $instance->addResource('xlf', '/Users/samuelrenel/Web/AWGregSam/Webinaire/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.fa.xlf', 'fa', 'validators');
        $instance->addResource('xlf', '/Users/samuelrenel/Web/AWGregSam/Webinaire/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.fi.xlf', 'fi', 'validators');
        $instance->addResource('xlf', '/Users/samuelrenel/Web/AWGregSam/Webinaire/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.fr.xlf', 'fr', 'validators');
        $instance->addResource('xlf', '/Users/samuelrenel/Web/AWGregSam/Webinaire/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.he.xlf', 'he', 'validators');
        $instance->addResource('xlf', '/Users/samuelrenel/Web/AWGregSam/Webinaire/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.hr.xlf', 'hr', 'validators');
        $instance->addResource('xlf', '/Users/samuelrenel/Web/AWGregSam/Webinaire/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.hu.xlf', 'hu', 'validators');
        $instance->addResource('xlf', '/Users/samuelrenel/Web/AWGregSam/Webinaire/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.hy.xlf', 'hy', 'validators');
        $instance->addResource('xlf', '/Users/samuelrenel/Web/AWGregSam/Webinaire/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.id.xlf', 'id', 'validators');
        $instance->addResource('xlf', '/Users/samuelrenel/Web/AWGregSam/Webinaire/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.it.xlf', 'it', 'validators');
        $instance->addResource('xlf', '/Users/samuelrenel/Web/AWGregSam/Webinaire/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.ja.xlf', 'ja', 'validators');
        $instance->addResource('xlf', '/Users/samuelrenel/Web/AWGregSam/Webinaire/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.lb.xlf', 'lb', 'validators');
        $instance->addResource('xlf', '/Users/samuelrenel/Web/AWGregSam/Webinaire/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.lt.xlf', 'lt', 'validators');
        $instance->addResource('xlf', '/Users/samuelrenel/Web/AWGregSam/Webinaire/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.mn.xlf', 'mn', 'validators');
        $instance->addResource('xlf', '/Users/samuelrenel/Web/AWGregSam/Webinaire/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.nb.xlf', 'nb', 'validators');
        $instance->addResource('xlf', '/Users/samuelrenel/Web/AWGregSam/Webinaire/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.nl.xlf', 'nl', 'validators');
        $instance->addResource('xlf', '/Users/samuelrenel/Web/AWGregSam/Webinaire/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.pl.xlf', 'pl', 'validators');
        $instance->addResource('xlf', '/Users/samuelrenel/Web/AWGregSam/Webinaire/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.pt.xlf', 'pt', 'validators');
        $instance->addResource('xlf', '/Users/samuelrenel/Web/AWGregSam/Webinaire/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.pt_BR.xlf', 'pt_BR', 'validators');
        $instance->addResource('xlf', '/Users/samuelrenel/Web/AWGregSam/Webinaire/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.ro.xlf', 'ro', 'validators');
        $instance->addResource('xlf', '/Users/samuelrenel/Web/AWGregSam/Webinaire/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.ru.xlf', 'ru', 'validators');
        $instance->addResource('xlf', '/Users/samuelrenel/Web/AWGregSam/Webinaire/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.sk.xlf', 'sk', 'validators');
        $instance->addResource('xlf', '/Users/samuelrenel/Web/AWGregSam/Webinaire/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.sl.xlf', 'sl', 'validators');
        $instance->addResource('xlf', '/Users/samuelrenel/Web/AWGregSam/Webinaire/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.sr_Cyrl.xlf', 'sr_Cyrl', 'validators');
        $instance->addResource('xlf', '/Users/samuelrenel/Web/AWGregSam/Webinaire/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.sr_Latn.xlf', 'sr_Latn', 'validators');
        $instance->addResource('xlf', '/Users/samuelrenel/Web/AWGregSam/Webinaire/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.sv.xlf', 'sv', 'validators');
        $instance->addResource('xlf', '/Users/samuelrenel/Web/AWGregSam/Webinaire/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.ua.xlf', 'ua', 'validators');
        $instance->addResource('xlf', '/Users/samuelrenel/Web/AWGregSam/Webinaire/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.zh_CN.xlf', 'zh_CN', 'validators');
        $instance->addResource('xlf', '/Users/samuelrenel/Web/AWGregSam/Webinaire/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.ca.xlf', 'ca', 'validators');
        $instance->addResource('xlf', '/Users/samuelrenel/Web/AWGregSam/Webinaire/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.cs.xlf', 'cs', 'validators');
        $instance->addResource('xlf', '/Users/samuelrenel/Web/AWGregSam/Webinaire/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.da.xlf', 'da', 'validators');
        $instance->addResource('xlf', '/Users/samuelrenel/Web/AWGregSam/Webinaire/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.de.xlf', 'de', 'validators');
        $instance->addResource('xlf', '/Users/samuelrenel/Web/AWGregSam/Webinaire/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.en.xlf', 'en', 'validators');
        $instance->addResource('xlf', '/Users/samuelrenel/Web/AWGregSam/Webinaire/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.es.xlf', 'es', 'validators');
        $instance->addResource('xlf', '/Users/samuelrenel/Web/AWGregSam/Webinaire/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.et.xlf', 'et', 'validators');
        $instance->addResource('xlf', '/Users/samuelrenel/Web/AWGregSam/Webinaire/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.eu.xlf', 'eu', 'validators');
        $instance->addResource('xlf', '/Users/samuelrenel/Web/AWGregSam/Webinaire/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.fa.xlf', 'fa', 'validators');
        $instance->addResource('xlf', '/Users/samuelrenel/Web/AWGregSam/Webinaire/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.fi.xlf', 'fi', 'validators');
        $instance->addResource('xlf', '/Users/samuelrenel/Web/AWGregSam/Webinaire/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.fr.xlf', 'fr', 'validators');
        $instance->addResource('xlf', '/Users/samuelrenel/Web/AWGregSam/Webinaire/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.he.xlf', 'he', 'validators');
        $instance->addResource('xlf', '/Users/samuelrenel/Web/AWGregSam/Webinaire/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.hr.xlf', 'hr', 'validators');
        $instance->addResource('xlf', '/Users/samuelrenel/Web/AWGregSam/Webinaire/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.hu.xlf', 'hu', 'validators');
        $instance->addResource('xlf', '/Users/samuelrenel/Web/AWGregSam/Webinaire/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.hy.xlf', 'hy', 'validators');
        $instance->addResource('xlf', '/Users/samuelrenel/Web/AWGregSam/Webinaire/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.id.xlf', 'id', 'validators');
        $instance->addResource('xlf', '/Users/samuelrenel/Web/AWGregSam/Webinaire/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.it.xlf', 'it', 'validators');
        $instance->addResource('xlf', '/Users/samuelrenel/Web/AWGregSam/Webinaire/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.ja.xlf', 'ja', 'validators');
        $instance->addResource('xlf', '/Users/samuelrenel/Web/AWGregSam/Webinaire/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.lb.xlf', 'lb', 'validators');
        $instance->addResource('xlf', '/Users/samuelrenel/Web/AWGregSam/Webinaire/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.lt.xlf', 'lt', 'validators');
        $instance->addResource('xlf', '/Users/samuelrenel/Web/AWGregSam/Webinaire/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.mn.xlf', 'mn', 'validators');
        $instance->addResource('xlf', '/Users/samuelrenel/Web/AWGregSam/Webinaire/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.nb.xlf', 'nb', 'validators');
        $instance->addResource('xlf', '/Users/samuelrenel/Web/AWGregSam/Webinaire/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.nl.xlf', 'nl', 'validators');
        $instance->addResource('xlf', '/Users/samuelrenel/Web/AWGregSam/Webinaire/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.pl.xlf', 'pl', 'validators');
        $instance->addResource('xlf', '/Users/samuelrenel/Web/AWGregSam/Webinaire/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.pt.xlf', 'pt', 'validators');
        $instance->addResource('xlf', '/Users/samuelrenel/Web/AWGregSam/Webinaire/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.pt_BR.xlf', 'pt_BR', 'validators');
        $instance->addResource('xlf', '/Users/samuelrenel/Web/AWGregSam/Webinaire/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.ro.xlf', 'ro', 'validators');
        $instance->addResource('xlf', '/Users/samuelrenel/Web/AWGregSam/Webinaire/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.ru.xlf', 'ru', 'validators');
        $instance->addResource('xlf', '/Users/samuelrenel/Web/AWGregSam/Webinaire/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.sk.xlf', 'sk', 'validators');
        $instance->addResource('xlf', '/Users/samuelrenel/Web/AWGregSam/Webinaire/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.sl.xlf', 'sl', 'validators');
        $instance->addResource('xlf', '/Users/samuelrenel/Web/AWGregSam/Webinaire/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.sr_Cyrl.xlf', 'sr_Cyrl', 'validators');
        $instance->addResource('xlf', '/Users/samuelrenel/Web/AWGregSam/Webinaire/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.sr_Latn.xlf', 'sr_Latn', 'validators');
        $instance->addResource('xlf', '/Users/samuelrenel/Web/AWGregSam/Webinaire/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.sv.xlf', 'sv', 'validators');
        $instance->addResource('xlf', '/Users/samuelrenel/Web/AWGregSam/Webinaire/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.ua.xlf', 'ua', 'validators');
        $instance->addResource('xlf', '/Users/samuelrenel/Web/AWGregSam/Webinaire/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.zh_CN.xlf', 'zh_CN', 'validators');
        $instance->addResource('yml', '/Users/samuelrenel/Web/AWGregSam/Webinaire/vendor/fos/userbundle/FOS/UserBundle/Resources/translations/FOSUserBundle.bg.yml', 'bg', 'FOSUserBundle');
        $instance->addResource('yml', '/Users/samuelrenel/Web/AWGregSam/Webinaire/vendor/fos/userbundle/FOS/UserBundle/Resources/translations/FOSUserBundle.ca.yml', 'ca', 'FOSUserBundle');
        $instance->addResource('yml', '/Users/samuelrenel/Web/AWGregSam/Webinaire/vendor/fos/userbundle/FOS/UserBundle/Resources/translations/FOSUserBundle.cs.yml', 'cs', 'FOSUserBundle');
        $instance->addResource('yml', '/Users/samuelrenel/Web/AWGregSam/Webinaire/vendor/fos/userbundle/FOS/UserBundle/Resources/translations/FOSUserBundle.da.yml', 'da', 'FOSUserBundle');
        $instance->addResource('yml', '/Users/samuelrenel/Web/AWGregSam/Webinaire/vendor/fos/userbundle/FOS/UserBundle/Resources/translations/FOSUserBundle.de.yml', 'de', 'FOSUserBundle');
        $instance->addResource('yml', '/Users/samuelrenel/Web/AWGregSam/Webinaire/vendor/fos/userbundle/FOS/UserBundle/Resources/translations/FOSUserBundle.en.yml', 'en', 'FOSUserBundle');
        $instance->addResource('yml', '/Users/samuelrenel/Web/AWGregSam/Webinaire/vendor/fos/userbundle/FOS/UserBundle/Resources/translations/FOSUserBundle.es.yml', 'es', 'FOSUserBundle');
        $instance->addResource('yml', '/Users/samuelrenel/Web/AWGregSam/Webinaire/vendor/fos/userbundle/FOS/UserBundle/Resources/translations/FOSUserBundle.et.yml', 'et', 'FOSUserBundle');
        $instance->addResource('yml', '/Users/samuelrenel/Web/AWGregSam/Webinaire/vendor/fos/userbundle/FOS/UserBundle/Resources/translations/FOSUserBundle.fa_IR.yml', 'fa_IR', 'FOSUserBundle');
        $instance->addResource('yml', '/Users/samuelrenel/Web/AWGregSam/Webinaire/vendor/fos/userbundle/FOS/UserBundle/Resources/translations/FOSUserBundle.fi.yml', 'fi', 'FOSUserBundle');
        $instance->addResource('yml', '/Users/samuelrenel/Web/AWGregSam/Webinaire/vendor/fos/userbundle/FOS/UserBundle/Resources/translations/FOSUserBundle.fr.yml', 'fr', 'FOSUserBundle');
        $instance->addResource('yml', '/Users/samuelrenel/Web/AWGregSam/Webinaire/vendor/fos/userbundle/FOS/UserBundle/Resources/translations/FOSUserBundle.hr.yml', 'hr', 'FOSUserBundle');
        $instance->addResource('yml', '/Users/samuelrenel/Web/AWGregSam/Webinaire/vendor/fos/userbundle/FOS/UserBundle/Resources/translations/FOSUserBundle.hu.yml', 'hu', 'FOSUserBundle');
        $instance->addResource('yml', '/Users/samuelrenel/Web/AWGregSam/Webinaire/vendor/fos/userbundle/FOS/UserBundle/Resources/translations/FOSUserBundle.it.yml', 'it', 'FOSUserBundle');
        $instance->addResource('yml', '/Users/samuelrenel/Web/AWGregSam/Webinaire/vendor/fos/userbundle/FOS/UserBundle/Resources/translations/FOSUserBundle.ja.yml', 'ja', 'FOSUserBundle');
        $instance->addResource('yml', '/Users/samuelrenel/Web/AWGregSam/Webinaire/vendor/fos/userbundle/FOS/UserBundle/Resources/translations/FOSUserBundle.lb.yml', 'lb', 'FOSUserBundle');
        $instance->addResource('yml', '/Users/samuelrenel/Web/AWGregSam/Webinaire/vendor/fos/userbundle/FOS/UserBundle/Resources/translations/FOSUserBundle.lv.yml', 'lv', 'FOSUserBundle');
        $instance->addResource('yml', '/Users/samuelrenel/Web/AWGregSam/Webinaire/vendor/fos/userbundle/FOS/UserBundle/Resources/translations/FOSUserBundle.nl.yml', 'nl', 'FOSUserBundle');
        $instance->addResource('yml', '/Users/samuelrenel/Web/AWGregSam/Webinaire/vendor/fos/userbundle/FOS/UserBundle/Resources/translations/FOSUserBundle.pl.yml', 'pl', 'FOSUserBundle');
        $instance->addResource('yml', '/Users/samuelrenel/Web/AWGregSam/Webinaire/vendor/fos/userbundle/FOS/UserBundle/Resources/translations/FOSUserBundle.pt_BR.yml', 'pt_BR', 'FOSUserBundle');
        $instance->addResource('yml', '/Users/samuelrenel/Web/AWGregSam/Webinaire/vendor/fos/userbundle/FOS/UserBundle/Resources/translations/FOSUserBundle.pt_PT.yml', 'pt_PT', 'FOSUserBundle');
        $instance->addResource('yml', '/Users/samuelrenel/Web/AWGregSam/Webinaire/vendor/fos/userbundle/FOS/UserBundle/Resources/translations/FOSUserBundle.ro.yml', 'ro', 'FOSUserBundle');
        $instance->addResource('yml', '/Users/samuelrenel/Web/AWGregSam/Webinaire/vendor/fos/userbundle/FOS/UserBundle/Resources/translations/FOSUserBundle.ru.yml', 'ru', 'FOSUserBundle');
        $instance->addResource('yml', '/Users/samuelrenel/Web/AWGregSam/Webinaire/vendor/fos/userbundle/FOS/UserBundle/Resources/translations/FOSUserBundle.sk.yml', 'sk', 'FOSUserBundle');
        $instance->addResource('yml', '/Users/samuelrenel/Web/AWGregSam/Webinaire/vendor/fos/userbundle/FOS/UserBundle/Resources/translations/FOSUserBundle.sl.yml', 'sl', 'FOSUserBundle');
        $instance->addResource('yml', '/Users/samuelrenel/Web/AWGregSam/Webinaire/vendor/fos/userbundle/FOS/UserBundle/Resources/translations/FOSUserBundle.sr_Latn.yml', 'sr_Latn', 'FOSUserBundle');
        $instance->addResource('yml', '/Users/samuelrenel/Web/AWGregSam/Webinaire/vendor/fos/userbundle/FOS/UserBundle/Resources/translations/FOSUserBundle.sv.yml', 'sv', 'FOSUserBundle');
        $instance->addResource('yml', '/Users/samuelrenel/Web/AWGregSam/Webinaire/vendor/fos/userbundle/FOS/UserBundle/Resources/translations/FOSUserBundle.tr.yml', 'tr', 'FOSUserBundle');
        $instance->addResource('yml', '/Users/samuelrenel/Web/AWGregSam/Webinaire/vendor/fos/userbundle/FOS/UserBundle/Resources/translations/FOSUserBundle.uk.yml', 'uk', 'FOSUserBundle');
        $instance->addResource('yml', '/Users/samuelrenel/Web/AWGregSam/Webinaire/vendor/fos/userbundle/FOS/UserBundle/Resources/translations/FOSUserBundle.zh_CN.yml', 'zh_CN', 'FOSUserBundle');
        $instance->addResource('yml', '/Users/samuelrenel/Web/AWGregSam/Webinaire/vendor/fos/userbundle/FOS/UserBundle/Resources/translations/validators.bg.yml', 'bg', 'validators');
        $instance->addResource('yml', '/Users/samuelrenel/Web/AWGregSam/Webinaire/vendor/fos/userbundle/FOS/UserBundle/Resources/translations/validators.cs.yml', 'cs', 'validators');
        $instance->addResource('yml', '/Users/samuelrenel/Web/AWGregSam/Webinaire/vendor/fos/userbundle/FOS/UserBundle/Resources/translations/validators.da.yml', 'da', 'validators');
        $instance->addResource('yml', '/Users/samuelrenel/Web/AWGregSam/Webinaire/vendor/fos/userbundle/FOS/UserBundle/Resources/translations/validators.de.yml', 'de', 'validators');
        $instance->addResource('yml', '/Users/samuelrenel/Web/AWGregSam/Webinaire/vendor/fos/userbundle/FOS/UserBundle/Resources/translations/validators.en.yml', 'en', 'validators');
        $instance->addResource('yml', '/Users/samuelrenel/Web/AWGregSam/Webinaire/vendor/fos/userbundle/FOS/UserBundle/Resources/translations/validators.es.yml', 'es', 'validators');
        $instance->addResource('yml', '/Users/samuelrenel/Web/AWGregSam/Webinaire/vendor/fos/userbundle/FOS/UserBundle/Resources/translations/validators.fa_IR.yml', 'fa_IR', 'validators');
        $instance->addResource('yml', '/Users/samuelrenel/Web/AWGregSam/Webinaire/vendor/fos/userbundle/FOS/UserBundle/Resources/translations/validators.fi.yml', 'fi', 'validators');
        $instance->addResource('yml', '/Users/samuelrenel/Web/AWGregSam/Webinaire/vendor/fos/userbundle/FOS/UserBundle/Resources/translations/validators.fr.yml', 'fr', 'validators');
        $instance->addResource('yml', '/Users/samuelrenel/Web/AWGregSam/Webinaire/vendor/fos/userbundle/FOS/UserBundle/Resources/translations/validators.hr.yml', 'hr', 'validators');
        $instance->addResource('yml', '/Users/samuelrenel/Web/AWGregSam/Webinaire/vendor/fos/userbundle/FOS/UserBundle/Resources/translations/validators.it.yml', 'it', 'validators');
        $instance->addResource('yml', '/Users/samuelrenel/Web/AWGregSam/Webinaire/vendor/fos/userbundle/FOS/UserBundle/Resources/translations/validators.ja.yml', 'ja', 'validators');
        $instance->addResource('yml', '/Users/samuelrenel/Web/AWGregSam/Webinaire/vendor/fos/userbundle/FOS/UserBundle/Resources/translations/validators.lv.yml', 'lv', 'validators');
        $instance->addResource('yml', '/Users/samuelrenel/Web/AWGregSam/Webinaire/vendor/fos/userbundle/FOS/UserBundle/Resources/translations/validators.nl.yml', 'nl', 'validators');
        $instance->addResource('yml', '/Users/samuelrenel/Web/AWGregSam/Webinaire/vendor/fos/userbundle/FOS/UserBundle/Resources/translations/validators.pl.yml', 'pl', 'validators');
        $instance->addResource('yml', '/Users/samuelrenel/Web/AWGregSam/Webinaire/vendor/fos/userbundle/FOS/UserBundle/Resources/translations/validators.pt_BR.yml', 'pt_BR', 'validators');
        $instance->addResource('yml', '/Users/samuelrenel/Web/AWGregSam/Webinaire/vendor/fos/userbundle/FOS/UserBundle/Resources/translations/validators.ru.yml', 'ru', 'validators');
        $instance->addResource('yml', '/Users/samuelrenel/Web/AWGregSam/Webinaire/vendor/fos/userbundle/FOS/UserBundle/Resources/translations/validators.sk.yml', 'sk', 'validators');
        $instance->addResource('yml', '/Users/samuelrenel/Web/AWGregSam/Webinaire/vendor/fos/userbundle/FOS/UserBundle/Resources/translations/validators.sl.yml', 'sl', 'validators');
        $instance->addResource('yml', '/Users/samuelrenel/Web/AWGregSam/Webinaire/vendor/fos/userbundle/FOS/UserBundle/Resources/translations/validators.sr_Latn.yml', 'sr_Latn', 'validators');
        $instance->addResource('yml', '/Users/samuelrenel/Web/AWGregSam/Webinaire/vendor/fos/userbundle/FOS/UserBundle/Resources/translations/validators.tr.yml', 'tr', 'validators');
        $instance->addResource('yml', '/Users/samuelrenel/Web/AWGregSam/Webinaire/vendor/fos/userbundle/FOS/UserBundle/Resources/translations/validators.uk.yml', 'uk', 'validators');
        $instance->addResource('yml', '/Users/samuelrenel/Web/AWGregSam/Webinaire/vendor/fos/userbundle/FOS/UserBundle/Resources/translations/validators.zh_CN.yml', 'zh_CN', 'validators');
        $instance->addResource('xlf', '/Users/samuelrenel/Web/AWGregSam/Webinaire/src/Wbn/WebinaireBundle/Resources/translations/messages.fr.xlf', 'fr', 'messages');
        $instance->addResource('yml', '/Users/samuelrenel/Web/AWGregSam/Webinaire/src/Wbn/UserBundle/Resources/translations/WbnUserBundle.fr.yml', 'fr', 'WbnUserBundle');
    ...
    protected function getTwigService()
    {
        ...
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'exception_controller' => 'Symfony\\Bundle\\TwigBundle\\Controller\\ExceptionController::showAction', 'cache' => '/Users/samuelrenel/Web/AWGregSam/Webinaire/app/cache/dev/twig', 'charset' => 'UTF-8', 'paths' => array()));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('/Users/samuelrenel/Web/AWGregSam/Webinaire/vendor/symfony/symfony/src/Symfony/Bridge/Twig/Resources/views/Form');
     ...
     *
     * @return EM50740f0c0c256_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager An instance of the doctrine.orm.default_entity_manager service
     */
    ...
    {
        $this->services['assetic.asset_factory'] = $instance = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), '/Users/samuelrenel/Web/AWGregSam/Webinaire/app/../web', true);
    ...
    {
        return $this->services['assetic.cache'] = new \Assetic\Cache\FilesystemCache('/Users/samuelrenel/Web/AWGregSam/Webinaire/app/cache/dev/assetic/assets');
    }
    ...
    protected function getSecurity_Access_DecisionManagerService()
    {
        ...
        $a->setCacheDir('/Users/samuelrenel/Web/AWGregSam/Webinaire/app/cache/dev/jms_security/expressions');
    ...
    protected function getSecurity_Authentication_ManagerService()
    {
        ...
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('50740f0bea81d'), 1 => new \Symfony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider($this->get('fos_user.user_manager'), $a, 'main', $this->get('security.encoder_factory'), true), 2 => new \Symfony\Component\Security\Core\Authentication\Provider\RememberMeAuthenticationProvider($a, '458edc0590db980af9f95347879fa1714d119a34', 'main'), 3 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('50740f0bea81d')), true);
    ...
    {
        $this->services['security.extra.metadata_factory'] = $instance = new \Metadata\MetadataFactory(new \Metadata\Driver\LazyLoadingDriver($this, 'security.extra.metadata_driver'), new \Metadata\Cache\FileCache('/Users/samuelrenel/Web/AWGregSam/Webinaire/app/cache/dev/jms_security', true));
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), '/Users/samuelrenel/Web/AWGregSam/Webinaire/app/cache/dev');
    }
    ...
    {
        return $this->services['validator.mapping.class_metadata_factory'] = new \Symfony\Component\Validator\Mapping\ClassMetadataFactory(new \Symfony\Component\Validator\Mapping\Loader\LoaderChain(array(0 => new \Symfony\Component\Validator\Mapping\Loader\AnnotationLoader($this->get('annotation_reader')), 1 => new \Symfony\Component\Validator\Mapping\Loader\StaticMethodLoader(), 2 => new \Symfony\Component\Validator\Mapping\Loader\XmlFilesLoader(array(0 => '/Users/samuelrenel/Web/AWGregSam/Webinaire/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/config/validation.xml', 1 => '/Users/samuelrenel/Web/AWGregSam/Webinaire/vendor/fos/userbundle/FOS/UserBundle/Resources/config/validation.xml', 2 => '/Users/samuelrenel/Web/AWGregSam/Webinaire/vendor/fos/userbundle/FOS/UserBundle/Resources/config/validation/orm.xml')), 3 => new \Symfony\Component\Validator\Mapping\Loader\YamlFilesLoader(array()))), NULL);
    }
    ...
    {
        return array(
            'kernel.root_dir' => '/Users/samuelrenel/Web/AWGregSam/Webinaire/app',
            'kernel.environment' => 'dev',
            'kernel.debug' => true,
            'kernel.name' => 'app',
            'kernel.cache_dir' => '/Users/samuelrenel/Web/AWGregSam/Webinaire/app/cache/dev',
            'kernel.logs_dir' => '/Users/samuelrenel/Web/AWGregSam/Webinaire/app/logs',
            'kernel.bundles' => array(
                ...
                'WbnWebinaireBundle' => 'Wbn\\WebinaireBundle\\WbnWebinaireBundle',
                'WbnUserBundle' => 'Wbn\\UserBundle\\WbnUserBundle',
            ...
            'locale' => 'fr',
            'secret' => '458edc0590db980af9f95347879fa1714d119a34',
            'database_path' => NULL,
            ...
            'debug.container.dump' => '/Users/samuelrenel/Web/AWGregSam/Webinaire/app/cache/dev/appDevDebugProjectContainer.xml',
            'debug.controller_resolver.class' => 'Symfony\\Bundle\\FrameworkBundle\\Controller\\TraceableControllerResolver',
            'kernel.secret' => '458edc0590db980af9f95347879fa1714d119a34',
            ...
            'session.save_path' => '/Users/samuelrenel/Web/AWGregSam/Webinaire/app/cache/dev/sessions',
            ...
            'validator.mapping.loader.xml_files_loader.mapping_files' => array(
                0 => '/Users/samuelrenel/Web/AWGregSam/Webinaire/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/config/validation.xml',
                1 => '/Users/samuelrenel/Web/AWGregSam/Webinaire/vendor/fos/userbundle/FOS/UserBundle/Resources/config/validation.xml',
                2 => '/Users/samuelrenel/Web/AWGregSam/Webinaire/vendor/fos/userbundle/FOS/UserBundle/Resources/config/validation/orm.xml',
            ),
            ...
            'profiler.storage.dsn' => 'file:/Users/samuelrenel/Web/AWGregSam/Webinaire/app/cache/dev/profiler',
            ...
            'router.resource' => '/Users/samuelrenel/Web/AWGregSam/Webinaire/app/cache/dev/assetic/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => '/Users/samuelrenel/Web/AWGregSam/Webinaire/app/cache/dev/twig',
                'charset' => 'UTF-8',
                'paths' => array(
            ...
            'swiftmailer.spool.memory.path' => '/Users/samuelrenel/Web/AWGregSam/Webinaire/app/cache/dev/swiftmailer/spool',
            ...
            'assetic.cache_dir' => '/Users/samuelrenel/Web/AWGregSam/Webinaire/app/cache/dev/assetic',
            ...
            'assetic.read_from' => '/Users/samuelrenel/Web/AWGregSam/Webinaire/app/../web',
            'assetic.write_to' => '/Users/samuelrenel/Web/AWGregSam/Webinaire/app/../web',
            ...
            'doctrine.orm.proxy_dir' => '/Users/samuelrenel/Web/AWGregSam/Webinaire/app/cache/dev/doctrine/orm/Proxies',
            ...
            'jms_aop.cache_dir' => '/Users/samuelrenel/Web/AWGregSam/Webinaire/app/cache/dev/jms_aop',
            ...
            'jms_di_extra.cache_dir' => '/Users/samuelrenel/Web/AWGregSam/Webinaire/app/cache/dev/jms_diextra',
            'jms_di_extra.doctrine_integration' => true,
            'jms_di_extra.doctrine_integration.entity_manager.file' => '/Users/samuelrenel/Web/AWGregSam/Webinaire/app/cache/dev/jms_diextra/doctrine/EntityManager.php',
            'jms_di_extra.doctrine_integration.entity_manager.class' => 'EM50740f0c0c256_546a8d27f194334ee012bfe64f629947b07e4919\\__CG__\\Doctrine\\ORM\\EntityManager',
            ...
            'security.extra.cache_dir' => '/Users/samuelrenel/Web/AWGregSam/Webinaire/app/cache/dev/jms_security',
            ...
            'fos_user.model.user.class' => 'Wbn\\UserBundle\\Entity\\User',
